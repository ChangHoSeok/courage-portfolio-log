...
public class WebLoggingFilter implements Filter {
	...
	private final static String INIT_PARAM_EXCLUDE_URI = "excludeStartWithURI";
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		if (webLoggingConfig.getInitParameter(INIT_PARAM_EXCLUDE_URI) != null) {
			excludeURIs = webLoggingConfig.getInitParameter(INIT_PARAM_EXCLUDE_URI);
		}
	}
	...
	private boolean isSkipURI(HttpServletRequest request) {
		String[] excludeURI = this.excludeURIs.split(",");
		
		for (String uri : excludeURI) {
			uri = request.getContextPath() + uri.replaceAll(" ", "");
